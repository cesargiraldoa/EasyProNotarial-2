...
class MoneyRulesTests(unittest.TestCase):
    ...
    def test_money_to_words_uses_currency_suffix_with_cents(self):
        ...
        self.assertEqual(
            money_to_words("680785432,12", "PESOS MONEDA CORRIENTE"),
        ...
        self.assertEqual(
            money_to_words("456789021,45", "PESOS MONEDA CORRIENTE"),
        ...
        self.assertEqual(
            money_to_words("345876234,12", "PESOS MONEDA CORRIENTE"),
